...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings and concatenates them for the name.
     *
     * @param first The first string to use for this Silly's name.
     * @param second the second string to use for this Silly's name (to be concatenated to first).
     */
